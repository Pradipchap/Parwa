...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        decoration:const  BoxDecoration(image:DecorationImage(image: AssetImage("images/home.jpg"),
        fit: BoxFit.cover,
        ),
        ),
  ...
  child: ListView(
    ...
    children: [
      const DrawerHeader(
        ...
        child: Text('Services',style: TextStyle(fontSize: 35),),
     ...
     const Divider(),
     ListTile(
        title: const  Text('Events',style: TextStyle(fontSize: 25),),
        onTap: () {
     ...
     const Divider(),
      ListTile(
        title: const Text('pujari', style: TextStyle(fontSize: 25),),
        onTap: () {
         Navigator.push(
                ctx,
     ...
     const Divider(),
      ListTile(
        title:const Text('Calender' ,style: TextStyle(fontSize: 25),),
        onTap: (){
          Navigator.push(
                ctx,
      ...
      const Divider(),
      ListTile(
        title:const Text('Hotels' ,style: TextStyle(fontSize: 25),),
        onTap: (){
          Navigator.push(
                ctx,
 ...
 body:
  ...
  SingleChildScrollView(
    ...
    Container(
      ...
      child: 
     const Text(
        'Events',style: TextStyle(fontSize: 30),
      ),
    ...
    Container(
      ...
      child: 
     const Text(
        'Vojanalaya',style: TextStyle(fontSize: 30),
      ),
    ...
    Container(
      ...
      child: 
     const Text(
        'Horoscope',style: TextStyle(fontSize: 30),
      ),
